...
//                }
    ...
    public void checkColor(View a, View b, View c, View d){
            a.setBackgroundColor(Color.parseColor("#33FFFF"));
            b.setBackgroundColor(Color.parseColor("#17A589"));
            c.setBackgroundColor(Color.parseColor("#17A589"));
            d.setBackgroundColor(Color.parseColor("#17A589"));
